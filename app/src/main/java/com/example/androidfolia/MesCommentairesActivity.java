...
public class MesCommentairesActivity extends ListActivity {
    ...
    private static final String TAG_TASK = "mes_commentaires";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mes_commentaires);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent in = new Intent(getApplicationContext(), CommentaireActivity.class);
    ...
    class LoadItems extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            // super.onPreExecute();
            pDialog = new ProgressDialog(MesCommentairesActivity.this);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if (json != null) {
                Toast.makeText(MesCommentairesActivity.this, json.toString(), Toast.LENGTH_LONG).show();  // TEST/DEBUG
                try {
            ...
            if (success == 1) {
                ...
                try {
                    ...
                    for (int i = 0; i < items.length(); i++) {
                        ...
                        String texte = obj.getString(TAG_TEXTE);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    adapter = new SimpleAdapter(
                            MesCommentairesActivity.this, itemsList,
                            R.layout.list_commentaire_item, new String[]{TAG_ID, TAG_AUTEUR, TAG_TITRE, TAG_TEXTE, TAG_DATE},
                            new int[]{R.id.aid, R.id.auteur, R.id.titre, R.id.texte, R.id.date});
